                ...
                if (selectedScore != null)
                  TextButton.icon(
                    ...
                    icon: Icon(
                      Icons.clear,
                      size: 15,
                      color: Brand.black.withValues(alpha: saving ? 0.3 : 0.50),
                    ),
                    label: Text(
                      _txt(context, 'clearSelection'),
                      style: TextStyle(
                        fontSize: 12,
                        color: Brand.black.withValues(alpha: saving ? 0.3 : 0.60),
                      ),
                    ),
              ...
              Center(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: Brand.assessmentCtaBlue.withValues(alpha: 0.45),
                    ),
                    backgroundColor: Brand.assessmentCtaBlue.withValues(alpha: 0.06),
