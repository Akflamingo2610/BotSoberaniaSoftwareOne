...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _data = {
    'pt': {
      ...
      'welcome_line2':
          'Faça um diagnóstico e descubra em que estágio sua operação se encontra',
      ...
      'intro_framework_title': '3Cs: como avaliamos sua soberanIA digital',
      ...
      'intro_about_card_body':
          'A SoftwareOne é uma empresa global especializada em software e nuvem, apoiando organizações na modernização de suas operações com mais segurança, eficiência e controle. Com expertise em ambientes regulados e reconhecimento como AWS Premier Partner, entregamos soluções com alto padrão de qualidade, consistência e governança.',
      'intro_assessment_card_title':
          'Assessment de Maturidade em Soberania Digital',
      'intro_assessment_card_body':
          'O Assessment de Maturidade em Soberania Digital avalia, de forma estruturada, o nível de controle, conformidade, resiliência e independência da sua operação. Com critérios objetivos e mensuráveis, você entende seu cenário atual, identifica lacunas e define os próximos passos alinhados às necessidades do negócio e às exigências regulatórias.',
      ...
      'intro_partnership_body':
          'A SoftwareOne é parceira estratégica da AWS em SoberanIA Digital, sendo a única empresa no Brasil e uma das poucas no mundo com competência reconhecida. Combinamos expertise em nuvem com conhecimento em requisitos regulatórios para apoiar organizações na construção de estratégias alinhadas ao negócio, à legislação e aos desafios dos ambientes digitais modernos.',
      'intro_sov_title': 'Soberania Digital',
      'intro_sov_body':
          'Soberania digital é a capacidade de uma organização manter controle, visibilidade e autonomia sobre seus dados, infraestrutura e operações digitais. Isso permite garantir conformidade regulatória, segurança e resiliência, ao mesmo tempo em que sustenta inovação, escalabilidade e crescimento contínuo.',
      ...
      'results_available_hint':
          'Complete todas as etapas para acessar seus resultados.',
      ...
      'login_subtitle': 'Explore o nivel de maturidade digitla do seu negócio.',
      ...
      'login_tip_config_xano':
          'Dica: configure a URL do Xano em lib/config.dart',
      'login_forgot_password': 'Recuperar senha',
      ...
      'signup_heading': 'Comece seu assessment',
      'signup_subtitle':
          'Descrubra o nível de maturidade digital da sua organização em poucos passos',
      ...
      'signup_password_label': 'Crie uma senha',
      ...
      'signup_marketing_consent':
          'Quero receber novidades e conteúdos da SoftwareOne.',
      'signup_privacy_prefix':
          'Ao enviar este formulário, os dados informados serão tratados e armazenados por nós para fins de contato. Seus dados não serão compartilhados com terceiros. Você pode consultar mais informações sobre seus dados e direitos em nossa ',
      'signup_privacy_link': 'Política de Privacidade',
      'btn_register': 'Continuar',
    ...
    'en': {
      ...
      'welcome_line2':
          "Run a diagnosis and find out what stage your operation is at",
      ...
      'intro_desc':
          'Learn more about SoftwareOne and the Digital Sovereignty Maturity Assessment.',
      ...
      'intro_framework_title': '3Cs: how we assess your digital sovereignty',
      'intro_framework_intro':
          'It helps identify priorities and define the next steps with clarity.',
      'intro_framework_bullet_1':
      ...
      'intro_compliance_title': 'Compliance',
      'intro_compliance_bullet_1':
          'Ensure compliance with laws, standards, and security requirements, with clear criteria for evaluation and decision-making.',
      'intro_compliance_bullet_2': '',
      'intro_control_title': 'Control',
      'intro_control_bullet_1':
          'Gain control over infrastructure, access, and data, strengthening the protection of critical assets and operational autonomy.',
      'intro_control_bullet_2': '',
      'intro_continuity_title': 'Continuity',
      'intro_continuity_bullet_1':
          'Prepare your operation to respond and recover, ensuring business continuity in the face of failures and crises.',
      'intro_continuity_bullet_2': '',
      'intro_about_card_title': 'About SoftwareOne',
      'intro_about_card_body':
          'SoftwareOne is a global company specialized in software and cloud, supporting organizations in modernizing their operations with greater security, efficiency, and control. With expertise in regulated environments and recognition as an AWS Premier Partner, we deliver solutions with high standards of quality, consistency, and governance.',
      'intro_assessment_card_title': 'Digital Sovereignty Maturity Assessment',
      'intro_assessment_card_body':
          'The Digital Sovereignty Maturity Assessment evaluates, in a structured way, the level of control, compliance, resilience, and independence of your operation. Using objective and measurable criteria, you understand your current scenario, identify gaps, and define the next steps aligned with business needs and regulatory requirements.',
      ...
      'intro_partnership_body':
          'SoftwareOne is a strategic AWS partner in Digital Sovereignty, being the only company in Brazil and one of the few worldwide with recognized competency. We combine cloud expertise with knowledge of regulatory requirements to support organizations in building strategies aligned with business goals, legislation, and the challenges of modern digital environments.',
      'intro_sov_title': 'Digital Sovereignty',
      'intro_sov_body':
          'Digital sovereignty is the ability of an organization to maintain control, visibility, and autonomy over its data, infrastructure, and digital operations. This enables regulatory compliance, security, and resilience, while also sustaining innovation, scalability, and continuous growth.',
      ...
      'results_available_hint': 'Complete all steps to access your results.',
      ...
      'login_subtitle': "Explore your business's digital maturity level.",
      ...
      'login_forgot_password': 'Recover password',
      'login_forgot_success':
          'If this email is registered, you will receive instructions to reset your password.',
      'signup_title': 'Sign up',
      'signup_heading': 'Start your assessment',
      'signup_subtitle':
          "Discover your organization's digital maturity level in a few steps.",
      ...
      'signup_marketing_consent':
          'I want to receive updates and content from SoftwareOne.',
      'signup_privacy_prefix':
          'By submitting this form, the entered data will be handled and stored by us for contact purposes. Your data will not be shared with third parties. You can review additional information about your data and rights in our ',
    ...
    'es': {
      ...
      'welcome_line2':
          'Realice un diagnóstico y descubra en qué etapa se encuentra su operación',
      ...
      'intro_desc':
          'Conozca más sobre SoftwareOne y el Assessment de Madurez en Soberanía Digital.',
      ...
      'intro_framework_title': '3Cs: cómo evaluamos su soberanía digital',
      'intro_framework_intro':
          'Ayuda a identificar prioridades y definir los próximos pasos con claridad.',
      'intro_framework_bullet_1':
      ...
      'intro_compliance_title': 'Compliance',
      'intro_compliance_bullet_1':
          'Garantice conformidad con leyes, normas y estándares de seguridad, con criterios claros para la evaluación y la toma de decisiones.',
      'intro_compliance_bullet_2': '',
      'intro_control_title': 'Control',
      'intro_control_bullet_1':
          'Tenga control sobre infraestructura, accesos y datos, fortaleciendo la protección de activos críticos y la autonomía de la operación.',
      'intro_control_bullet_2': '',
      'intro_continuity_title': 'Continuity',
      'intro_continuity_bullet_1':
          'Prepare su operación para responder y recuperarse, asegurando la continuidad del negocio frente a fallas y crisis.',
      'intro_continuity_bullet_2': '',
      'intro_about_card_title': 'Sobre SoftwareOne',
      'intro_about_card_body':
          'SoftwareOne es una empresa global especializada en software y nube, que apoya a las organizaciones en la modernización de sus operaciones con mayor seguridad, eficiencia y control. Con expertise en entornos regulados y reconocimiento como AWS Premier Partner, entregamos soluciones con altos estándares de calidad, consistencia y gobernanza.',
      'intro_assessment_card_title':
          'Assessment de Madurez en Soberanía Digital',
      'intro_assessment_card_body':
          'El Assessment de Madurez en Soberanía Digital evalúa, de forma estructurada, el nivel de control, conformidad, resiliencia e independencia de su operación. Con criterios objetivos y medibles, usted comprende su escenario actual, identifica brechas y define los próximos pasos alineados con las necesidades del negocio y las exigencias regulatorias.',
      ...
      'intro_partnership_body':
          'SoftwareOne es socio estratégico de AWS en Soberanía Digital, siendo la única empresa en Brasil y una de las pocas en el mundo con competencia reconocida. Combinamos expertise en nube con conocimiento de requisitos regulatorios para apoyar a las organizaciones en la construcción de estrategias alineadas con el negocio, la legislación y los desafíos de los entornos digitales modernos.',
      'intro_sov_title': 'Soberanía Digital',
      'intro_sov_body':
          'La soberanía digital es la capacidad de una organización para mantener control, visibilidad y autonomía sobre sus datos, infraestructura y operaciones digitales. Esto permite garantizar conformidad regulatoria, seguridad y resiliencia, al mismo tiempo que sostiene la innovación, la escalabilidad y el crecimiento continuo.',
      ...
      'results_available_hint':
          'Complete todas las etapas para acceder a sus resultados.',
      ...
      'login_subtitle': 'Explore el nivel de madurez digital de su negocio.',
      ...
      'login_tip_config_xano':
          'Consejo: configure la URL de Xano en lib/config.dart',
      ...
      'signup_heading': 'Comience su assessment',
      'signup_subtitle':
          'Descubra el nivel de madurez digital de su organización en pocos pasos.',
      ...
      'signup_phone_invalid':
          'El teléfono debe tener 10 u 11 dígitos (con código de área)',
      'signup_company_label': 'Empresa',
      ...
      'signup_marketing_consent':
          'Quiero recibir novedades y contenidos de SoftwareOne.',
      'signup_privacy_prefix':
          'Al enviar este formulario, los datos informados serán tratados y almacenados por nosotros para fines de contacto. Sus datos no serán compartidos con terceros. Puede consultar más información sobre sus datos y derechos en nuestra ',
      'signup_privacy_link': 'Política de Privacidad',
      'btn_register': 'Continuar',
      'signup_already_have': '¿Ya tiene cuenta? ',
      'no_account': 'Crear cuenta',
